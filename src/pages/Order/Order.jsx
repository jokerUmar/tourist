...
function Order() {
  ...
  const {arrayData , setArrayData} = useContext(ArrayDataContext)
        ...
        <div className="order_box">
          ...
          <div className="order_box-right">
            ...
            <div className="order_box-list">
              {
                arrayData.map(el =>{
                  return <div key={el.id} className="order_box-item">
                <p>{el.title}ga sayohat ×{el.count}</p>
            ...
            <div className="order-btn_box">
              <button className="take-order-btn">Buyurtmani tasdiqlang</button>
            </div>
          </div>
        </div>
      </div>
